...
const BASE_PATH = 'design-ideas/wt-5834-contact-centre/contact-centre-agent';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const START_PATH = '/design-ideas/wt-5834-contact-centre/contact-centre-agent/nino-search';
