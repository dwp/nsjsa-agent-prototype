...
const BASE_PATH = 'sprints/sprint11/7-previous-employment';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = '/sprints/sprint11/8-abroad';
...
router.get('/', function (req, res) {
  res.redirect('/sprints/sprint11/7-previous-employment/job-ended-last-six-months');
});
