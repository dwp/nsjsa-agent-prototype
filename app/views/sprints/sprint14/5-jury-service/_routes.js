...
const BASE_PATH = 'sprints/sprint14/5-jury-service';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = '/sprints/sprint14/6-current-employment';
...
router.post('/have-been', function (req, res) {
  ...
  //   res.redirect('/sprints/sprint14/5-jury-service/period');
  // } else {
  //   res.redirect('/sprints/sprint14/6-current-employment');
  // }
