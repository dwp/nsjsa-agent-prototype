...
const BASE_PATH = 'previous-work/agent/stage/1a/7-previous-employment';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = '/previous-work/agent/stage/1a/8-abroad';
...
router.get('/', function (req, res) {
  res.redirect('/previous-work/agent/stage/1a/7-previous-employment/job-ended-last-six-months');
});
