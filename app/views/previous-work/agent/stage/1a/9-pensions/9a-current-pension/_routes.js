...
const LIMIT_WARNING_PATH = '/previous-work/agent/stage/1a/9-pensions/limit-warning';
const BASE_PATH = 'previous-work/agent/stage/1a/9-pensions/9a-current-pension';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = '/previous-work/agent/stage/1a/10-education';
