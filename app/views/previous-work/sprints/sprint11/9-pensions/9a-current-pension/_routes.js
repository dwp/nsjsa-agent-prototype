...
const LIMIT_WARNING_PATH = '/sprints/sprint11/9-pensions/limit-warning';
const BASE_PATH = 'sprints/sprint11/9-pensions/9a-current-pension';
const ABS_BASE_PATH = `/${BASE_PATH}`;
const NEXT_PATH = '/sprints/sprint11/10-education';
