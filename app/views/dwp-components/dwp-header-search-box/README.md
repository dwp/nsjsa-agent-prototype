...
Custom DWP header component based on the GOVUL Header component

## Guidance

Find out when to use the GOVUK header component in your service in the [GOV.UK Design System](https://design-system.service.gov.uk/components/header).

## Quick start examples

### Header

[Preview the original GOVUK example in the Frontend review app](http://govuk-frontend-review.herokuapp.com/components/header/preview)
...
#### Markup
    ...
    <header class="dwp-header " role="banner" data-module="dwp-header">
      <div class="dwp-header__container govuk-width-container">
        ...
        <div class="dwp-header__logo">
          <a href="/" class="dwp-header__link dwp-header__link--homepage">
            <span class="dwp-header__logotype">

              <svg
                role="presentation"
                focusable="false"
                class="dwp-header__logotype-crown"
              ...
              >
                ...
                <image src="/assets/images/govuk-logotype-crown.png" class="dwp-header__logotype-crown-fallback-image"></image>
              </svg>
              <span class="dwp-header__logotype-text">
                GOV.UK
              </span>
            </span>
...
#### Markup
    ...
    <header class="dwp-header " role="banner" data-module="dwp-header">
      <div class="dwp-header__container govuk-width-container">
        ...
        <div class="dwp-header__content">

        <a href="/components/header" class="dwp-header__link dwp-header__link--service-name">
          Service Name
        </a>
...
#### Markup
    ...
    <header class="dwp-header " role="banner" data-module="dwp-header">
      <div class="dwp-header__container govuk-width-container">
        ...
        <button role="button" class="dwp-header__menu-button js-header-toggle" aria-controls="navigation" aria-label="Show or hide Top Level Navigation">Menu</button>
        <nav>
          <ul id="navigation" class="dwp-header__navigation " aria-label="Top Level Navigation">

                <li class="dwp-header__navigation-item dwp-header__navigation-item--active">
                  <a class="dwp-header__link" href="#1">
                    Navigation item 1
                  </a>
                </li>

                <li class="dwp-header__navigation-item">
                  <a class="dwp-header__link" href="#2">
                    Navigation item 2
                  </a>
                </li>

                <li class="dwp-header__navigation-item">
                  <a class="dwp-header__link" href="#3">
                    Navigation item 3
                  </a>
                </li>

                <li class="dwp-header__navigation-item">
                  <a class="dwp-header__link" href="#4">
                    Navigation item 4
                  </a>
                </li>
